...
for i in range(0,6):
    ...
    os.system('python mainseed.py --algo ppo --use-gae --gail --gail-experts-dir gail_experts --num-steps 2048 --num-processes 2 --env-name "InvertedDoublePendulumPyBulletEnv-v0" --use-linear-lr-decay --eval-interval 50 --log-dir log/subdoubinvpendseed --gail-agent-dir trained_models/ppo --log-interval 1 --num-env-steps 1000000 --seed '+str(i)+' --demonstration-coef 0.03')
    os.system('python mainseed.py --algo ppo --use-gae --gail --gail-experts-dir gail_experts --num-steps 2048 --num-processes 2 --env-name "InvertedPendulumPyBulletEnv-v0" --use-linear-lr-decay --eval-interval 50 --log-dir log/subinvpendseed --gail-agent-dir trained_models/ppo --log-interval 1 --num-env-steps 1000000 --seed '+str(i)+' --demonstration-coef 0.03')
